                ...
                <div style="flex: 1; min-width: 250px;">
                    ...
                    <div style="position: relative; display: flex; align-items: center;">
                        <input 
                            ...
                            style="width: 100%; padding: 0.75rem 52px 0.75rem 0.75rem; background: var(--bg-tertiary); border: 1px solid var(--border-color); border-radius: var(--glass-radius-sm); color: var(--text-primary); font-size: 0.875rem; transition: all 0.3s ease;"
